...
class CreatePlantesTable extends Migration
{
    ...
    public function up()
    {
        ...
        DB::table('plantes')->insert(array(
            'nom' => "cornifle",
            'nom_latin' => "ceratophyllum demersum",
        ...
        DB::table('plantes')->insert(array(
            'nom' => "anubias de barter",
            'nom_latin' => "anubias barteri",
        ...
        DB::table('plantes')->insert(array(
            'nom' => "étoile des marais",
            'nom_latin' => "alternanthera rosaefolia",
        ...
        DB::table('plantes')->insert(array(
            'nom' => "bacopa",
            'nom_latin' => "bacopa amplexicaulis",
